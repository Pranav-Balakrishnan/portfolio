...
* **Massive Scalability:** Experiments demonstrate a **100x increase in scenario complexity** (scaling up to 100 hypotheses and 20+ objects) yielded only a **3x rise in processing time** on server-grade GPUs.
